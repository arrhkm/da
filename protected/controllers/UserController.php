...
class UserController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			*/
			...
			array('allow',
				'actions'=>array('admin', 'delete', 'index', 'view', 'create', 'update', 'changepassword', 'setpassword'),
	...
	{      
	    ...
	    $model = User::model()->findByAttributes(array('employee_id'=>$id));
